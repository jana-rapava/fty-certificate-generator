/*  =========================================================================
    fty-certificate-generator - generated layer of public API
...
#ifndef FTY_CERTIFICATE_GENERATOR_LIBRARY_H_INCLUDED
#define FTY_CERTIFICATE_GENERATOR_LIBRARY_H_INCLUDED
...
#define FTY_CERTIFICATE_GENERATOR_VERSION_MINOR 0
#define FTY_CERTIFICATE_GENERATOR_VERSION_PATCH 0

#define FTY_CERTIFICATE_GENERATOR_MAKE_VERSION(major, minor, patch) \
...
#   elif defined FTY_CERTIFICATE_GENERATOR_INTERNAL_BUILD
#       if defined DLL_EXPORT
#           define FTY_CERTIFICATE_GENERATOR_EXPORT __declspec(dllexport)
#       else
#           define FTY_CERTIFICATE_GENERATOR_EXPORT
#       endif
#   elif defined FTY_CERTIFICATE_GENERATOR_EXPORTS
#       define FTY_CERTIFICATE_GENERATOR_EXPORT __declspec(dllexport)
#   else
#       define FTY_CERTIFICATE_GENERATOR_EXPORT __declspec(dllimport)
#   endif
#   define FTY_CERTIFICATE_GENERATOR_PRIVATE
#elif defined (__CYGWIN__)
#   define FTY_CERTIFICATE_GENERATOR_EXPORT
#   define FTY_CERTIFICATE_GENERATOR_PRIVATE
#else
#   if (defined __GNUC__ && __GNUC__ >= 4) || defined __INTEL_COMPILER
#       define FTY_CERTIFICATE_GENERATOR_PRIVATE __attribute__ ((visibility ("hidden")))
#       define FTY_CERTIFICATE_GENERATOR_EXPORT __attribute__ ((visibility ("default")))
#   else
#       define FTY_CERTIFICATE_GENERATOR_PRIVATE
#       define FTY_CERTIFICATE_GENERATOR_EXPORT
#   endif
...
#undef  FTY_CERTIFICATE_GENERATOR_BUILD_DRAFT_API
#define FTY_CERTIFICATE_GENERATOR_BUILD_DRAFT_API
